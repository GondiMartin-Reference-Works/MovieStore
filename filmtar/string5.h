 ...
 * len a hossz.A hosszba nem számit bele a lezáró nulla.
 */
class String {
...
public:
    ...
    /// Konstruktor egy char karakterbol
    /// @param ch - karakter
    String(char ch);
    ...
    /// Másoló konstruktor
    /// @param s1 - String, amibol létrehozzuk az új String-et
    String(const String& s1);

    /// Destruktor
    virtual ~String() { delete[] pData; }

    /// Kiirunk egy Stringet (debug célokra)
    /// Elotte kiirunk egy tetszoleges szöveget.
    ...
    /// @return baoldali (módositott) string (referenciája)
...
/// Globális függvények:
/// kiir az ostream-re
/// @param os - ostream tipusú objektum
/// @param s0 - String, amit kiirunk
/// @return os
std::ostream& operator<<(std::ostream& os, const String& s0);

/// Beolvas az istream-rol egy sort egy string-be.
/// @param is - istream tipusú objektum
